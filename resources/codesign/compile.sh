...
sandbox+="-alias,_APP_SANDBOX_READ,_APP_SANDBOX_READ,"
...
gcc -dynamiclib base.m -o sandbox.dylib -Wl,$sandbox -arch armv7 -isysroot $isysroot_location -framework CoreFoundation -framework Foundation -lm -lsandbox -install_name /usr/lib/system/libsystem_sandbox.dylib -current_version 1.0 -compatibility_version 1.0
