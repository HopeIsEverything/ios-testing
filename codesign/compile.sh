...
gcc -dynamiclib base.c -o sandbox.dylib -Wl,$sandbox -nostdlib -framework CoreFoundation -lm -install_name /usr/lib/system/libsystem_sandbox.dylib
gcc -dynamiclib base.c -o amfi.dylib -Wl,$amfi -nostdlib -framework CoreFoundation -install_name /usr/lib/libmis.dylib
