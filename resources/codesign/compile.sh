...
gcc -dynamiclib base.m -o sandbox.dylib -Wl,$sandbox -arch armv7 -isysroot $isysroot_location -framework CoreFoundation -framework Foundation -lm -install_name /usr/lib/system/libsystem_sandbox.dylib -current_version 1.0 -compatibility_version 1.0
