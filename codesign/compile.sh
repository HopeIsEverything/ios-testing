...
gcc -dynamiclib base.c -o sandbox.dylib -Wl,$sandbox -arch armv7 -nostdlib -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk -framework CoreFoundation -lm -install_name /usr/lib/system/libsystem_sandbox.dylib
gcc -dynamiclib base.c -o amfi.dylib -Wl,$amfi -arch armv7 -nostdlib -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk -framework CoreFoundation -lm -install_name /usr/lib/libmis.dylib
